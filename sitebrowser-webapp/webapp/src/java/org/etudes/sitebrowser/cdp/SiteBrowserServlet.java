/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/sitebrowser/trunk/sitebrowser-webapp/webapp/src/java/org/etudes/sitebrowser/cdp/SiteBrowserServlet.java $
 * $Id: SiteBrowserServlet.java 5241 2013-06-21 20:23:30Z ggolden $
 ***********************************************************************************
 *
...
/**
 */
public class SiteBrowserServlet extends HttpServlet
{
	/** Our log (commons). */
	private static Log M_log = LogFactory.getLog(SiteBrowserServlet.class);
	...
	public void init(ServletConfig config) throws ServletException
	{
		...
		final CdpHandler handler = new SiteBrowserCdpHandler();
